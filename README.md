# powershell-2 fichier avec le contenu de chacun des 2 dossiers EvenFolder et OddFolder
...
# powershell-2 Un fichier avec les différentes lignes de commandes
...
PS C:\FolderTest1> Get-ChildItem -Path *Folder* -Recurse > listing.txt

PS C:\FolderTest1> Get-ChildItem -Path *Folder* -Recurse > listing.txt

PS C:\FolderTest1> Get-Location
